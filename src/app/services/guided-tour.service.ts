  ...
  private buildSteps(): GuidedTourStep[] {
    ...
    const steps: GuidedTourStep[] = [
      ...
      },
      {
        ...
        text: 'Ricerca, personalita, luogo, tema, durata e budget servono per restringere rapidamente le missioni piu adatte a dove sei e a quanto tempo hai.',
        accent: 'Filtri'
      },
      {
        route: archiveRoute,
      ...
      },
      {
        ...
        text: 'Con "Apri percorso" entri nel dettaglio della missione. Con "Salva" la tieni tra i preferiti per ritrovarla al volo.',
    ...
    if (personalMission) {
      steps.push({
        route: detailRoute,
        selector: '#tutorial-mission-status',
