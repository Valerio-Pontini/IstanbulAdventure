window.QUIZ_CONTENT = {
  ...
  introText: "Rispondi d’istinto. Alcune scelte apriranno un indizio o una frase narrativa prima della domanda successiva.",
  ...
  questions: [
    {
      ...
      answers: [
        ...
        {
          label: "Guardi il percorso dove potresti scegliere",
          nextId: "e_1"
        },
        {
    ...
    },
    {
      ...
      answers: [
        ...
        {
          label: "Cerchi di capire quando è stato stato costruito",
          nextId: "a_7"
        },
        {
    ...
    },
    {
      ...
      answers: [
        ...
        {
          label: "Ti interessa la storia in sé",
          nextId: "c_25"
        },
        {
